...
export class MyProfile {
  ...
  constructor(private authenticationServiceObject: AuthenticationService, private fb: FormBuilder, @Inject(PLATFORM_ID) platformId: object, private commonFunctionObject: CommonFunction, private SuperAdminServiceObject: SuperAdminService, private errorObject: Errors, private cd: ChangeDetectorRef) {
