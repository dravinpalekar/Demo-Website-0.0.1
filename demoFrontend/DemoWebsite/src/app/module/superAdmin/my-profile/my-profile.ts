...
export class MyProfile {
  ...
  constructor(private authenticationServiceObject: AuthenticationAuthorizationService, private fb: FormBuilder, @Inject(PLATFORM_ID) platformId: object, private commonFunctionObject: CommonFunction, private SuperAdminServiceObject: SuperAdminServices, private errorObject: Errors, private cd: ChangeDetectorRef) {
