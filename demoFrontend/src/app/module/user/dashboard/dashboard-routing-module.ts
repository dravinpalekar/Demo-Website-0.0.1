...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: allRoutes.createRole, loadComponent: () => import('./component/find-friend/find-friend').then(m => m.FindFriend) },
      { path: 'editRole/:id', loadComponent: () => import('./component/chat-box/chat-box').then(m => m.ChatBox) },
