...
""")
    Page<UserEntity> findUsersByRoleAndActiveAndDeletedAtIsNull(@Param("role") Roles role, @Param("userId") Long userId, @Param("active") Status active, Pageable pageable);
